...
public class k {
    ...
    public static final int[] f1193c = {R.attr.indeterminateDrawable, R.attr.progressDrawable};

    /* renamed from: a, reason: collision with root package name */
    public final ProgressBar f1194a;

    /* renamed from: b, reason: collision with root package name */
    public Bitmap f1195b;

    public k(ProgressBar progressBar) {
        this.f1194a = progressBar;
    }

    public void a(AttributeSet attributeSet, int i10) {
        ProgressBar progressBar = this.f1194a;
        m0 m10 = m0.m(progressBar.getContext(), attributeSet, f1193c, i10);
        Drawable f = m10.f(0);
        if (f != null) {
        ...
        if (f10 != null) {
            progressBar.setProgressDrawable(b(f10, false));
        }
        m10.n();
    }
