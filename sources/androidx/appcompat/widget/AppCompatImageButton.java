...
public class AppCompatImageButton extends ImageButton {
    ...
    public final c f955s;

    /* renamed from: t, reason: collision with root package name */
    public final i f956t;
    ...
    public final boolean hasOverlappingRendering() {
        if ((!(this.f956t.f1189a.getBackground() instanceof RippleDrawable)) && super.hasOverlappingRendering()) {
            return true;
        }
        return false;
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        i iVar = this.f956t;
        if (iVar != null && drawable != null && !this.f957u) {
