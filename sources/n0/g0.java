...
public final class g0 {
    ...
    public static final Method f33078a;
    ...
    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f33078a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    public static float a(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f33078a) != null) {
            try {
