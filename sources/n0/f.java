...
public final class f {
    ...
    public static boolean f33073a = false;

    /* renamed from: b, reason: collision with root package name */
    public static Method f33074b = null;

    /* renamed from: c, reason: collision with root package name */
    public static boolean f33075c = false;

    /* renamed from: d, reason: collision with root package name */
    public static Field f33076d;
    ...
    public static boolean a(View view, KeyEvent keyEvent) {
        ...
        if (Build.VERSION.SDK_INT < 28) {
            ArrayList<WeakReference<View>> arrayList = c0.s.f33068d;
            c0.s sVar = (c0.s) view.getTag(R.id.tag_unhandled_key_event_manager);
            if (sVar == null) {
                sVar = new c0.s();
                view.setTag(R.id.tag_unhandled_key_event_manager, sVar);
            }
            WeakReference<KeyEvent> weakReference2 = sVar.f33071c;
            if (weakReference2 == null || weakReference2.get() != keyEvent) {
                sVar.f33071c = new WeakReference<>(keyEvent);
                if (sVar.f33070b == null) {
                    sVar.f33070b = new SparseArray<>();
                }
                SparseArray<WeakReference<View>> sparseArray = sVar.f33070b;
                ...
                if (weakReference != null) {
                    ...
                    if (view2 == null || !c0.g.b(view2)) {
                        return true;
                    }
                    c0.s.b(view2, keyEvent);
                    return true;
                }
            }
        }
    ...
    */
    public static boolean b(n0.f.a r7, android.view.View r8, android.view.Window.Callback r9, android.view.KeyEvent r10) {
        /*
            r0 = 0
            if (r7 != 0) goto L4
            return r0
        ...
        Lf:
            ...
            n0.f.f33074b = r1     // Catch: java.lang.NoSuchMethodException -> L4a
        L4a:
            n0.f.f33073a = r3
        L4c:
            java.lang.reflect.Method r1 = n0.f.f33074b
            if (r1 == 0) goto L61
