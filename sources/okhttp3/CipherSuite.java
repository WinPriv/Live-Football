...
public final class CipherSuite {
    ...
    static final Comparator<String> ORDER_BY_NAME = new l(7);
    ...
    public static final CipherSuite TLS_EMPTY_RENEGOTIATION_INFO_SCSV = init("TLS_EMPTY_RENEGOTIATION_INFO_SCSV", p.f9095b);
