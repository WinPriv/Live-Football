...
public final class PublicSuffixDatabase {
        ...
        while (i14 < length) {
            ...
            while (true) {
                if (z11) {
                    ...
                    z10 = z11;
                    i12 = bArr2[i19][i20] & DefaultClassResolver.NAME;
                }
                i13 = i12 - (bArr[i16 + i21] & DefaultClassResolver.NAME);
                if (i13 == 0) {
                    i21++;
                    i20++;
                    if (i21 == i18) {
    ...
    private void readTheList() throws IOException {
        ...
        u uVar = new u(new k(new n(resourceAsStream, new a0())));
        try {
            byte[] bArr = new byte[uVar.readInt()];
            uVar.readFully(bArr);
            byte[] bArr2 = new byte[uVar.readInt()];
