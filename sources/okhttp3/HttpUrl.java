...
public final class HttpUrl {
    ...
    public static String canonicalize(String str, int i10, int i11, String str2, boolean z10, boolean z11, boolean z12, boolean z13, @Nullable Charset charset) {
        int i12 = i10;
        while (i12 < i11) {
            ...
            b bVar = new b();
            bVar.g0(i10, i12, str);
            canonicalize(bVar, str, i12, i11, str2, z10, z11, z12, z13, charset);
            return bVar.l();
        }
    ...
    public static final class Builder {
                ...
                while (true) {
                    ...
                    if (c10 == '@') {
                        if (!z10) {
                            ...
                            if (z11) {
                                canonicalize = k.m(new StringBuilder(), this.encodedUsername, "%40", canonicalize);
                            }
        ...
        public Builder port(int i10) {
            ...
            throw new IllegalArgumentException(l.i("unexpected port: ", i10));
        }
    ...
    public static String percentDecode(String str, int i10, int i11, boolean z10) {
        for (int i12 = i10; i12 < i11; i12++) {
            ...
            if (charAt == '%' || (charAt == '+' && z10)) {
                b bVar = new b();
                bVar.g0(i10, i12, str);
                percentDecode(bVar, str, i12, i11, z10);
                return bVar.l();
            }
        }
        return str.substring(i10, i11);
    ...
    public static void canonicalize(b bVar, String str, int i10, int i11, String str2, boolean z10, boolean z11, boolean z12, boolean z13, @Nullable Charset charset) {
        b bVar2 = null;
        while (i10 < i11) {
            ...
            if (!z10 || (codePointAt != 9 && codePointAt != 10 && codePointAt != 12 && codePointAt != 13)) {
                if (codePointAt == 43 && z12) {
                    ...
                    if (charset != null && !charset.equals(StandardCharsets.UTF_8)) {
                        bVar2.f0(str, i10, Character.charCount(codePointAt) + i10, charset);
                    } else {
                        bVar2.h0(codePointAt);
                    }
                    while (!bVar2.u()) {
                        int readByte = bVar2.readByte() & DefaultClassResolver.NAME;
                        bVar.Z(37);
    ...
    public static void percentDecode(b bVar, String str, int i10, int i11, boolean z10) {
        int i12;
        while (i10 < i11) {
            int codePointAt = str.codePointAt(i10);
            if (codePointAt == 37 && (i12 = i10 + 2) < i11) {
                ...
                if (decodeHexDigit != -1 && decodeHexDigit2 != -1) {
                    bVar.Z((decodeHexDigit << 4) + decodeHexDigit2);
                    i10 = i12;
                }
                bVar.h0(codePointAt);
            } else {
    ...
    public static String canonicalize(String str, String str2, boolean z10, boolean z11, boolean z12, boolean z13, @Nullable Charset charset) {
