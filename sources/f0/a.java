...
public final class a {
    ...
    public static final ThreadLocal<double[]> f27897a = new ThreadLocal<>();
    ...
    public static int a(double d10, double d11, double d12) {
        ...
        if (round < 0) {
            ...
            min = Math.min(round, p.f9095b);
        }
        int round2 = (int) Math.round(d14 * 255.0d);
        if (round2 < 0) {
            min2 = 0;
        } else {
            min2 = Math.min(round2, p.f9095b);
        }
        int round3 = (int) Math.round(d15 * 255.0d);
        if (round3 >= 0) {
            i10 = Math.min(round3, p.f9095b);
        }
    ...
    public static int b(int i10, int i11) {
        ...
        int i14 = 255 - alpha2;
        int i15 = 255 - (((255 - alpha) * i14) / p.f9095b);
        ...
        if (i15 == 0) {
            ...
            i12 = (((red2 * alpha) * i14) + ((red * p.f9095b) * alpha2)) / (i15 * p.f9095b);
        }
        ...
        if (i15 == 0) {
            ...
            i13 = (((green2 * alpha) * i14) + ((green * p.f9095b) * alpha2)) / (i15 * p.f9095b);
        }
        int blue = Color.blue(i10);
        int blue2 = Color.blue(i11);
        if (i15 != 0) {
            i16 = (((blue2 * alpha) * i14) + ((blue * p.f9095b) * alpha2)) / (i15 * p.f9095b);
        }
