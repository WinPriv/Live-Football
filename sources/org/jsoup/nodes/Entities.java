...
public class Entities {
    ...
    public enum EscapeMode {
        ...
        public String[] f33994v;

        EscapeMode(String str, String str2) {
            int i10;
            char[] cArr = Entities.f33987a;
            this.f33991s = new String[r10];
            this.f33992t = new int[r10];
            this.f33993u = new int[r10];
            this.f33994v = new String[r10];
            CharacterReader characterReader = new CharacterReader(str2);
            int i11 = 0;
            while (!characterReader.isEmpty()) {
                try {
                    String consumeTo = characterReader.consumeTo('=');
                    characterReader.advance();
                    int parseInt = Integer.parseInt(characterReader.consumeToAny(Entities.f33987a), 36);
                    ...
                    characterReader.advance();
                    this.f33991s[i11] = consumeTo;
                    this.f33992t[i11] = parseInt;
                    this.f33993u[parseInt2] = parseInt;
                    this.f33994v[parseInt2] = consumeTo;
                    if (i10 != -1) {
                        Entities.f33988b.put(consumeTo, new String(new int[]{parseInt, i10}, 0, 2));
                    }
                    i11++;
                } finally {
            ...
            Validate.isTrue(i11 == r10, "Unexpected count of entities loaded");
        }

        public final int a(String str) {
            int binarySearch = Arrays.binarySearch(this.f33991s, str);
            if (binarySearch >= 0) {
                return this.f33992t[binarySearch];
            }
            return -1;
        }
    }
    ...
    public static void a(Appendable appendable, EscapeMode escapeMode, int i10) throws IOException {
        String str;
        int binarySearch = Arrays.binarySearch(escapeMode.f33993u, i10);
        if (binarySearch < 0) {
            str = "";
        } else {
            String[] strArr = escapeMode.f33994v;
            if (binarySearch < strArr.length - 1) {
                int i11 = binarySearch + 1;
                if (escapeMode.f33993u[i11] == i10) {
                    str = strArr[i11];
                }
            }
    ...
    public static void b(Appendable appendable, String str, Document.OutputSettings outputSettings, boolean z10, boolean z11, boolean z12, boolean z13) throws IOException {
        EscapeMode escapeMode = outputSettings.escapeMode();
        CharsetEncoder charsetEncoder = outputSettings.f33974u.get();
        if (charsetEncoder == null) {
            charsetEncoder = outputSettings.a();
        }
        int i10 = outputSettings.f33975v;
                ...
                if (c10 != '\t' && c10 != '\n' && c10 != '\r') {
                    if (c10 != '\"') {
                        if (c10 != '&') {
                            ...
                            } else if (z10 && escapeMode != EscapeMode.xhtml && outputSettings.syntax() != Document.OutputSettings.Syntax.xml) {
                                appendable.append(c10);
                            } else {
                                appendable.append("&lt;");
                            }
    ...
    public static int codepointsForName(String str, int[] iArr) {
        String str2 = f33988b.get(str);
        if (str2 != null) {
            iArr[0] = str2.codePointAt(0);
            iArr[1] = str2.codePointAt(1);
            return 2;
        }
        int a10 = EscapeMode.extended.a(str);
        if (a10 == -1) {
            return 0;
        }
        iArr[0] = a10;
    ...
    public static String escape(String str, Document.OutputSettings outputSettings) {
        ...
        try {
            b(borrowBuilder, str, outputSettings, false, false, false, false);
    ...
    public static String getByName(String str) {
        ...
        int a10 = EscapeMode.extended.a(str);
        if (a10 != -1) {
            return new String(new int[]{a10}, 0, 1);
        }
        return "";
    }
