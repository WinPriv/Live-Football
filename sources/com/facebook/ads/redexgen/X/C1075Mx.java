...
public class C1075Mx extends WebViewClient {
    ...
    public final WeakReference<C1197Rq> A03;
    ...
    public final WeakReference<C1137Pi> A07;
    ...
    public C1075Mx(C1316Wj c1316Wj, WeakReference<InterfaceC1073Mv> weakReference, WeakReference<C1137Pi> weakReference2, WeakReference<L6> weakReference3, WeakReference<AtomicBoolean> checkAssetsByJavascriptBridge, WeakReference<C1197Rq> weakReference4, AtomicInteger atomicInteger, AtomicReference<String> requestId, boolean z10) {
        this.A02 = c1316Wj;
    ...
    private WebResourceResponse A00() {
        return new WebResourceResponse(A01(286, 10, 35), StandardCharsets.UTF_8.name(), ag.f22001l, A01(13, 6, 93), Collections.singletonMap(A01(0, 13, 85), A01(268, 8, 38)), new ByteArrayInputStream(A01(13, 6, 93).getBytes()));
    }
    ...
    private void A03(int i10, CharSequence charSequence, long j10) {
        ...
        try {
            ...
            jSONObject.put(A01(a.f11393p, 21, 64), z10);
            jSONObject.put(A01(223, 22, 64), j10);
            jSONObject.put(A01(276, 10, 2), this.A09.get());
        } catch (JSONException unused) {
        }
        this.A02.A06().A8u(A01(306, 8, 32), C06977l.A2c, new C06987m(AdErrorType.WEB_VIEW_FAILED_TO_LOAD.getDefaultErrorMessage(), A01(55, 12, 72) + jSONObject.toString()));
    }
    ...
    private final void A05(WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) {
        ...
        this.A02.A0D().AFS(webResourceResponse.getStatusCode(), C1008Kh.A01(webResourceResponse.getStatusCode(), A01(67, 10, 55), A01(0, 0, 49) + webResourceRequest.getUrl()));
    }
    ...
    private void A07(String str, String str2) {
        ...
        try {
            ...
            jSONObject.put(A01(com.anythink.expressad.foundation.g.a.aP, 10, 58), str2);
            jSONObject.put(A01(276, 10, 2), this.A09.get());
        } catch (JSONException unused) {
        }
        C1316Wj c1316Wj = this.A02;
        if (c1316Wj != null) {
            c1316Wj.A06().A8u(A01(306, 8, 32), C06977l.A2Z, new C06987m(AdErrorType.WEB_VIEW_CACHE_FILE_WAS_DENIED.getDefaultErrorMessage(), A01(55, 12, 72) + jSONObject.toString()));
        }
    }
    ...
    public final void onPageStarted(WebView webView, String str, Bitmap bitmap) {
        ...
        this.A02.A0D().AFQ();
        this.A00 = new Date();
        new Handler().postDelayed(new C1198Rr(this), this.A08.get());
    }
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        ...
        this.A02.A0D().AFR(C1008Kh.A01(webResourceError.getErrorCode(), A01 + ((Object) webResourceError.getDescription()), A01 + webResourceRequest.getUrl()));
    }
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        AbstractC1070Ms.A02(C06977l.A2Y);
        InterfaceC1073Mv adWebViewListener = this.A04.get();
