...
public final class IQ {
    ...
    public IQ(C7G c7g, String str, double d10, String str2, @Nullable Map<String, String> map, IV iv, IW iw, boolean z10) {
        this.A05 = str;
        this.A00 = d10;
        this.A04 = str2;
        this.A02 = iv;
        ...
        String A01 = C0956Id.A01(str);
        if (!TextUtils.isEmpty(A01) && (z10 || iw == IW.A0C)) {
            hashMap.put(A00(6, 21, 61), A01);
        }
        if (A0B()) {
            Map<String, String> extraData = c7g.A02().A5g();
            hashMap.put(A00(0, 6, 63), C1010Kj.A01(extraData));
        }
