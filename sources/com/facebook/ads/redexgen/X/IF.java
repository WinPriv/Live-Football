...
public final class IF {
    ...
    public static HashMap<String, Integer> A0M(Context context) throws JSONException {
        String A2D = ID.A0P(context).A2D(A0L(24, 35, 123), A0L(22, 2, 109));
    ...
    public static int A06(Context context) {
        return ID.A0P(context).A2B(A0L(275, 45, 119), 0);
    }
    ...
    public static int A0H(Context context, String str, int i10) {
        int A2B = ID.A0P(context).A2B(str, i10);
        if (A2B >= 0 && A2B < 101) {
            return A2B;
        }
        return i10;
    ...
    public static long A0J(Context context) {
        return ID.A0P(context).A2B(A0L(IronSourceError.ERROR_IS_ALL_SMASHES_SESSION_CAPPED, 41, 66), 300) * 1000;
    }

    public static long A0K(Context context) {
        return ID.A0P(context).A2C(A0L(IronSourceConstants.RV_CALLBACK_AVAILABILITY_TRUE, 34, 102), 500L);
    }
    ...
    public static boolean A0P(Context context) {
        return ID.A0P(context).A2G(A0L(ag.O, 18, 53), false);
    }
