...
public class C05752g<K, V> {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C05752g) {
            C05752g c05752g = (C05752g) obj;
            if (size() != c05752g.size()) {
                return false;
            }
            for (int i10 = 0; i10 < this.A00; i10++) {
                try {
                    K A09 = A09(i10);
                    V A0B = A0B(i10);
                    Object obj2 = c05752g.get(A09);
                    if (A0B == null) {
                        if (obj2 == null && c05752g.containsKey(A09)) {
                        }
                        return false;
                    }
                    if (!A0B.equals(obj2)) {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2g != com.facebook.ads.internal.androidx.support.v4.util.SimpleArrayMap<K, V> */
    public final V A0C(int i10, V v3) {
        int i11 = (i10 << 1) + 1;
        Object[] objArr = this.A02;
        V v10 = (V) objArr[i11];
        objArr[i11] = v3;
