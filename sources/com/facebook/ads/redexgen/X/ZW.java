...
public final class ZW implements C0K {
    ...
    private HttpURLConnection A02(int i10, int i11) throws IOException, ZY {
        String A01;
        ...
        do {
            ...
            sb2.append(A01(234, 16, 102));
            if (i10 > 0) {
                A01 = A01(19, 13, 86) + i10;
            } else {
                A01 = A01(0, 0, 78);
            }
            sb2.append(A01);
            ...
            if (i10 > 0) {
                httpURLConnection.setRequestProperty(A01(IronSourceConstants.INTERSTITIAL_DAILY_CAPPED, 5, 60), A01(322, 6, a.R) + i10 + A01(50, 1, 18));
            }
            if (i11 > 0) {
    ...
    private void A03() throws ZY {
        String str = A01(p.f9095b, 23, 28) + this.A03;
        ...
        try {
            try {
                ...
                Log.e(A07, A01(a.T, 25, 77) + this.A03, e10);
                C0I.A05(inputStream);
    ...
    private final void A05(int i10, int i11) throws ZY {
        try {
            ...
            throw new ZY(A01(154, 29, 63) + this.A03 + A01(19, 13, 86) + i10, e10);
        }
    }
    ...
    public final void ACr(int i10) throws ZY {
        A05(i10, this.A00);
    }
    ...
    public final int read(byte[] bArr) throws ZY {
        ...
        if (inputStream != null) {
            try {
                ...
                throw new F5(A01(com.anythink.expressad.foundation.g.a.aS, 15, 96) + this.A03 + A01(0, 15, 66), e10);
            } catch (IOException e11) {
                throw new ZY(A01 + this.A03, e11);
            }
        }
