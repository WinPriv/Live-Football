...
public final class IB {
    ...
    public IB(C1316Wj c1316Wj, String str, String str2) {
        this.A03 = c1316Wj;
        this.A05 = str;
        this.A04 = str2;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A07(int i10, C06987m c06987m) {
        this.A03.A06().A8u(A05(189, 14, 74), i10, c06987m);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A08(int i10, C06987m c06987m) {
        c06987m.A03(1);
        this.A03.A06().A8v(A05(189, 14, 74), i10, c06987m);
    }

    public final void A0C() {
        A08(C06977l.A1s, new C06987m(A05(101, 18, 66), this.A05));
        Intent intent = new Intent();
        intent.setClassName(A05(170, 19, 125), A05(119, 51, 26));
        try {
            if (!this.A03.bindService(intent, this.A02, 1)) {
                A08(C06977l.A1o, new C06987m(A05(51, 50, 11)));
                this.A03.unbindService(this.A02);
            }
        } catch (Exception e10) {
            A07(C06977l.A1n, new C06987m(e10));
        }
    }
}
