...
public enum EnumC0973Iu {
    A06(-1, 100, 1, 0),
    A07(-1, 120, 2, 1),
    A08(-1, 300, 3, 2),
    A09(-1, ag.f21998i, 4, 3),
    A0A(-1, 50, 5, 4),
    A0B(-1, -1, 6, 5);
    ...
    EnumC0973Iu(int i10, int i11, int i12, int i13) {
        this.A03 = i10;
        this.A01 = i11;
        this.A02 = i12;
        this.A00 = i13;
    ...
    public static EnumC0973Iu A00(int i10) {
        for (EnumC0973Iu enumC0973Iu : values()) {
            if (enumC0973Iu.A00 == i10) {
                return enumC0973Iu;
            }
        }
        return null;
