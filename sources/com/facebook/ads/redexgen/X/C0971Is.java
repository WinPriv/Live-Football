...
public final class C0971Is implements NativeAdRatingApi {
    ...
    public C0971Is(double d10, double d11) {
        this.A01 = d10;
        this.A00 = d11;
    }

    @Nullable
    public static C0971Is A00(@Nullable JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        if (A03[1].length() == 15) {
            ...
            if (optDouble != 0.0d) {
                if (A03[5].charAt(0) == 'R') {
                    ...
                    if (optDouble2 != 0.0d) {
                        return new C0971Is(optDouble, optDouble2);
                    }
                }
            }
            return null;
