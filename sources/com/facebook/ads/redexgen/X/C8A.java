...
public final class C8A {
    ...
    public static long A01(C7G c7g) {
        try {
            ...
            if (A03.compareAndSet(false, true)) {
                c7g.A06().A8u(A02(144, 7, 117), C06977l.A1E, new C06987m(e10));
            }
            return -1L;
        }
    }
    ...
    public static String A05(C7G c7g) {
        ...
        A07(c7g, jSONObject, A02(174, 6, a.R), String.valueOf(A08()));
        A07(c7g, jSONObject, A02(97, 8, 52), String.valueOf(A01(c7g)));
        A07(c7g, jSONObject, A02(180, 15, 73), String.valueOf(A00()));
        A07(c7g, jSONObject, A02(105, 18, 113), String.valueOf(K4.A01(c7g)));
        A07(c7g, jSONObject, A02(161, 13, 111), String.valueOf(A09(c7g)));
