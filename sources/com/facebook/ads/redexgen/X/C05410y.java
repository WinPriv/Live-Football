...
public final class C05410y extends BroadcastReceiver {
    ...
    public C05410y(C1316Wj c1316Wj, String str, ZB zb2, InterfaceC05400x interfaceC05400x) {
        this.A02 = c1316Wj;
        this.A03 = str;
        this.A01 = interfaceC05400x;
        this.A00 = zb2;
    }
    ...
    public final void A02() {
        ...
        intentFilter.addAction(A00(ag.f22000k, 46, 38) + this.A03);
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (intentAction5.equals(str)) {
            InterfaceC05400x interfaceC05400x = this.A01;
            ZB zb2 = this.A00;
            String[] parts3 = A05;
            if (parts3[3].charAt(4) != 'D') {
                A05[0] = "TqpNublq1V6zWfVafs4QLB";
                interfaceC05400x.AAx(zb2);
                return;
            } else {
        ...
        String intentAction6 = A00(m.a.f10162a, 47, 11);
        ...
        if (intentAction9.equals(str)) {
            InterfaceC05400x interfaceC05400x2 = this.A01;
            String[] strArr = A05;
        ...
        InterfaceC05400x interfaceC05400x3 = this.A01;
        String[] parts4 = A05;
        if (parts4[7].charAt(0) != 'P') {
            throw new RuntimeException();
        }
        A05[0] = "2dNMpRkIvORsTqY7tSIXPx";
        interfaceC05400x3.AB2();
    }
}
