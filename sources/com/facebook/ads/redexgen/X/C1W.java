...
public final class C1W implements Serializable {
    ...
    public C1W(String str, String str2, int i10, String str3, String str4, N3 n32, int i11, boolean z10, boolean z11, C1X c1x, boolean z12, String str5) {
        if (z12) {
            this.A08 = UUID.randomUUID().toString();
            Uri uri = KM.A00(str).buildUpon().appendQueryParameter(A03(132, 11, 111), this.A08).appendQueryParameter(A03(58, 12, 69), str5).build();
