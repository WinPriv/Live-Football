...
public final class C07128a {
    ...
    public C07128a(File file) {
        this.A00 = file;
    }

    public static C07128a A00(String str, Context context) throws IOException {
        File filesDir = new File(context.getFilesDir(), A01(64, 9, 55));
        A03(filesDir);
        File fbsdklogDir = new File(filesDir, str);
        A03(fbsdklogDir);
        return new C07128a(fbsdklogDir);
    }
    ...
    public final C07128a A04(String str) throws IOException {
        File file = new File(this.A00, str);
        A03(file);
        return new C07128a(file);
    }
