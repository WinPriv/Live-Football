...
public enum EnumC1009Ki {
    ...
    EnumC1009Ki(int i10, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i10;
        this.A01 = nativeComponentTag;
    }

    public static EnumC1009Ki A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        for (EnumC1009Ki enumC1009Ki : values()) {
            if (enumC1009Ki.A01 == nativeComponentTag) {
                return enumC1009Ki;
            }
        }
        return null;
    ...
    public static void A03(View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC1009Ki internalTag = A00(nativeComponentTag);
        if (view != null && internalTag != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(View view, EnumC1009Ki enumC1009Ki) {
        if (view != null && enumC1009Ki != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, enumC1009Ki);
        }
    }
