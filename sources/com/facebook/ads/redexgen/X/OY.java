...
public final class OY {
    ...
    public OY(C7G c7g, OX ox, IT it, Map<String, String> metricsData, String str) {
        ...
        this.A06 = str;
        this.A04 = new C0954Ib(this.A06, this.A03);
    ...
    private void A02() {
        this.A04.A02(EnumC0953Ia.A0Z, null);
    }
    ...
    private void A05(String str) {
        ...
        hashMap2.put(A00(39, 11, 87), C1010Kj.A01(hashMap));
        A07(hashMap2);
    }

    private void A06(String str, float f, float f10) {
        HashMap hashMap = new HashMap();
    ...
    @JavascriptInterface
    public void logButtonClick(String str, float f, float f10) {
        if (!this.A08) {
            return;
        }
        A06(str, f, f10);
