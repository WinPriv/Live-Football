...
public final class KN {
    ...
    public static int A00(C1316Wj c1316Wj, int i10) {
        return C0983Jf.A00(c1316Wj).getInt(A01(0, 21, 2), i10);
    }

    @Nullable
    public static String A02(C1316Wj c1316Wj, @Nullable String str) {
        int A002 = A00(c1316Wj, -1);
        if (A002 == -1) {
            return null;
        }
        try {
    ...
    public final InterstitialAd A06(C1316Wj c1316Wj, String str, @Nullable String str2) {
        if (c1316Wj == null) {
            return null;
        }
        try {
            InterstitialAd interstitialAd = new InterstitialAd(c1316Wj, str);
    ...
    public final RewardedVideoAd A07(C1316Wj c1316Wj, String str, @Nullable String str2) {
        if (c1316Wj == null) {
            return null;
        }
        try {
            RewardedVideoAd rewardedVideoAd = new RewardedVideoAd(c1316Wj, str);
    ...
    public final void A08(C1316Wj c1316Wj, boolean z10) {
        int i10 = 0;
        String A01 = A01(0, 21, 2);
        if (!z10) {
            int lastNonChainedAds = C0983Jf.A00(c1316Wj).getInt(A01, 0);
            i10 = lastNonChainedAds + 1;
        }
        C0983Jf.A00(c1316Wj).edit().putInt(A01, i10).apply();
    }

    public final boolean A09(C1316Wj c1316Wj, @Nullable String str, int i10) {
        if (i10 <= 0) {
            return false;
        }
        try {
            if (!A05(str)) {
                int lastNonChainedAds = A00(c1316Wj, i10 - 1);
