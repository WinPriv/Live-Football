...
public class SL implements InterfaceC1027La {
    ...
    public SL(SH sh, AnonymousClass59 anonymousClass59) {
        this.A01 = sh;
    ...
    public final void AAE() {
        this.A01.A0B.A02(EnumC0953Ia.A07, null);
        if (this.A01.A0a()) {
            return;
        }
        if (this.A01.A0X()) {
