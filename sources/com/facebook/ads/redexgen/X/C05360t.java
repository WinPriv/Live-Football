...
public final class C05360t {
     ...
     */
    public final synchronized void A0A(String str) throws JSONException, C06987m {
        if (str != null) {
            if (!str.trim().isEmpty()) {
    ...
    private final synchronized C1O A00(String str, JSONObject jSONObject) throws JSONException, C06987m {
        ...
        if (str.equals(jSONObject.optString(A01(29, 12, 116), null))) {
            ...
            C06987m c06987m = new C06987m(new IllegalArgumentException());
