...
public final class Z0 extends AbstractC05320p {
    ...
    @Nullable
    public View A01;
    public EnumC05420z A02;
    public AnonymousClass10 A03;
    public EnumC0973Iu A04;
    ...
    public Z0(C1316Wj c1316Wj, AbstractC05330q abstractC05330q, C1137Pi c1137Pi, Z9 z92) {
        super(c1316Wj, abstractC05330q, c1137Pi);
        this.A02 = EnumC05420z.A03;
        this.A03 = null;
        this.A0D = z92;
    }
    ...
    */
    ...
    public final void A06(Map<String, String> map) {
        ...
        EnumC0973Iu enumC0973Iu = this.A04;
        if (enumC0973Iu != null) {
            map.put(A01(97, 3, 121), String.valueOf(enumC0973Iu.A04()));
        }
        if (this.A07) {
        ...
        EnumC05420z enumC05420z = this.A02;
        if (enumC05420z != null) {
            map.put(A01(106, 14, 33), enumC05420z.toString());
        }
        if (this.A09) {
    ...
    public final void A09(EnumC05420z enumC05420z) {
        this.A02 = enumC05420z;
    }
    ...
    public final void A0B(EnumC0973Iu enumC0973Iu) {
        this.A04 = enumC0973Iu;
    }
