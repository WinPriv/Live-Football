...
public final class AnonymousClass16 extends BroadcastReceiver {
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (str3.equals(action5)) {
            ...
            if (serializableExtra instanceof C0992Jp) {
                if (this.A01.getListener() != null) {
                ...
                if (this.A02) {
                    ...
                    this.A01.A0Y(((C0992Jp) serializableExtra).A01());
                }
                this.A01.setVisibility(0);
                this.A01.A0b(EnumC1121Os.A04, 1);
                return;
            }
            if (serializableExtra instanceof L7) {
                if (this.A01.getListener() == null) {
                    return;
                }
                InterfaceC1037Lk listener = this.A01.getListener();
                String[] split3 = A04;
            ...
            if (serializableExtra instanceof C1012Kl) {
                if (this.A01.getListener() == null) {
                    return;
                }
            ...
            if (serializableExtra instanceof C6v) {
                if (this.A01.getListener() != null) {
            ...
            if (serializableExtra instanceof KV) {
                if (this.A01.getListener() != null) {
                    InterfaceC1037Lk listener2 = this.A01.getListener();
                    String[] split4 = A04;
            ...
            if (!(serializableExtra instanceof C06836s) || this.A01.getListener() == null) {
                return;
            }
