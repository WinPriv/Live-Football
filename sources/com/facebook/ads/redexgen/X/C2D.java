...
public final class C2D {
    ...
    static {
        A06();
        A03 = new String[]{A02(452, 7, 20), A02(459, 19, 105), A02(478, 25, 96), A02(503, 15, 30), A02(IronSourceError.ERROR_BN_RELOAD_SKIP_INVISIBLE, 9, 99), A02(622, 21, 8), A02(643, 27, 68), A02(670, 17, 53), A02(540, 21, 23), A02(418, 16, 83), A02(434, 18, 91), A02(398, 20, 78), A02(696, 20, 116), A02(352, 14, 46), A02(561, 25, 112)};
    }
    ...
    private String A01() {
        return A03(A02(643, 27, 68), A02(a.T, 64, 34));
    }
    ...
    public static List<C2H> A04(String str) throws JSONException {
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            ...
            Iterator<C2H> it = A04(jSONObject.optString(A02(382, 16, 100))).iterator();
            while (it.hasNext()) {
                c2h.A06(it.next());
            }
            children.add(c2h);
    ...
    public static Map<String, String> A05(@Nullable String str) {
        ...
        try {
            ...
            if (A04(jSONObject.getString(A02(670, 17, 53))).size() == 0) {
                A08(C06977l.A27, new C06987m(A02(239, 20, 101)));
                return null;
            }
            if (A04(jSONObject.getString(A02(503, 15, 30))).size() == 0) {
                A08(C06977l.A24, new C06987m(A02(221, 18, 10)));
                return null;
            }
            return hashMap;
        } catch (JSONException e10) {
            A08(C06977l.A26, new C06987m(e10));
            return null;
        }
    }
    ...
    private final void A07() {
        ...
        A56.ADK(A02(518, 22, 120), 0L);
        A56.A3N();
    }

    public static void A08(int i10, C06987m c06987m) {
        C1315Wi sdkContext = C7F.A00();
        if (sdkContext != null) {
            sdkContext.A06().A8u(A02(687, 9, 5), i10, c06987m);
        }
    }

    public final long A09() {
        return this.A00.A6s(A02(518, 22, 120), 0L);
    }
    ...
    public final C2H A0A() {
        ...
        try {
            ...
            A07();
            A08(C06977l.A25, new C06987m(e10));
        }
        return c2h;
    }
    ...
    public final C2H A0B() {
        ...
        try {
            ...
            A07();
            A08(C06977l.A28, new C06987m(e10));
        }
        return c2h;
    }
    ...
    public final void A0N(@Nullable String str) {
        ...
        A56.ADK(A02(518, 22, 120), System.currentTimeMillis());
        A56.A3N();
    }

    public final boolean A0O(Context context, boolean z10) {
        return (z10 || ID.A1r(context)) && ((A09() > 0L ? 1 : (A09() == 0L ? 0 : -1)) > 0);
    }
}
