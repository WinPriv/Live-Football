...
public final class ZX implements C0G {
    ...
    public final synchronized void A07() throws ZV {
        ...
        try {
            ...
            throw new ZV(A00(123, 14, 124) + this.A00 + A00(0, 14, 84), e10);
        }
    }
    ...
    public ZX(File file, C0B c0b) throws ZV {
        ...
        try {
            ...
            throw new ZV(A00(186, 17, 126) + file + A00(0, 14, 84), e10);
        }
    }
    ...
    public final synchronized int A03() throws ZV {
        try {
            ...
            throw new ZV(A00(137, 29, 81) + this.A00, e10);
        }
    ...
    public final synchronized void A06() throws ZV {
        try {
            ...
            throw new ZV(A00(104, 19, 99) + this.A00, e10);
        }
    }

    public final synchronized void A08(byte[] bArr, int i10) throws ZV {
        try {
            if (!A09()) {
                this.A01.seek(A03());
                this.A01.write(bArr, 0, i10);
            } else {
                throw new ZV(A00(73, 31, 52) + this.A00 + A00(30, 14, 118));
            }
        } catch (IOException e10) {
            throw new ZV(String.format(Locale.US, A00(203, 53, 105), Integer.valueOf(i10), this.A01, Integer.valueOf(bArr.length)), e10);
        }
    }
