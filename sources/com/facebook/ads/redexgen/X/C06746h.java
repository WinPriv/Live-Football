...
public final class C06746h extends M1 {
    ...
    public final AbstractC1044Lr A01;
    public final AbstractC1011Kk A02;
    public final K6 A03;
    ...
    public C06746h(C1316Wj c1316Wj) {
        super(c1316Wj);
        this.A00 = null;
        this.A01 = new AbstractC1044Lr() { // from class: com.facebook.ads.redexgen.X.6l
            ...
            public final void A03(C6v c6v) {
                ...
                AudioManager audioManager = (AudioManager) C06746h.this.getContext().getApplicationContext().getSystemService(A00(0, 5, 67));
                weakReference = C06746h.this.A00;
                if (weakReference == null) {
                    onAudioFocusChangeListener = null;
                } else {
                    weakReference2 = C06746h.this.A00;
                    onAudioFocusChangeListener = (AudioManager.OnAudioFocusChangeListener) weakReference2.get();
                }
                audioManager.abandonAudioFocus(onAudioFocusChangeListener);
            }
        };
        this.A02 = new AbstractC1011Kk() { // from class: com.facebook.ads.redexgen.X.6k
            public static byte[] A01;
            ...
            public final void A03(C06836s c06836s) {
                ...
                WeakReference weakReference2;
                AudioManager.OnAudioFocusChangeListener onAudioFocusChangeListener;
                AudioManager audioManager = (AudioManager) C06746h.this.getContext().getApplicationContext().getSystemService(A00(0, 5, 113));
                weakReference = C06746h.this.A00;
                if (weakReference == null) {
                    onAudioFocusChangeListener = null;
                } else {
