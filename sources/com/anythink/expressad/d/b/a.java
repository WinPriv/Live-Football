...
public class a {
    ...
    public class AnonymousClass2 implements Runnable {
        ...
        public final void run() {
            try {
                ...
                m.a(this.f7196a.getBytes(), file);
            } catch (Exception e10) {
                o.a(a.f7190a, e10.getMessage());
            }
        }
    }
    ...
    public static /* synthetic */ void b(a aVar, String str) {
        com.anythink.core.common.k.b.a.a().a(new AnonymousClass2(str));
    }
    ...
    private void a(Context context, final String str) {
        ...
        String a10 = com.anythink.expressad.foundation.a.a.a.a().a(f7190a);
        if (TextUtils.isEmpty(a10) || !a10.equals(str)) {
            try {
                new com.anythink.expressad.d.a.a(context).a(str, (com.anythink.expressad.foundation.g.f.h.b) null, new com.anythink.expressad.foundation.g.f.b.b() { // from class: com.anythink.expressad.d.b.a.1
                    @Override // com.anythink.expressad.foundation.g.f.b.b
                    public final void a(String str2) {
                        if (!TextUtils.isEmpty(str2)) {
                            a.this.f7193d = str2;
                            a.b(a.this, str2);
                            com.anythink.expressad.foundation.a.a.a.a().a(a.f7190a, str);
                        }
                    }
