...
public class ATNativeImageView extends ImageView {
    ...
    public void setImage(String str, int i10, int i11) {
        ...
        b.a(getContext()).a(new e(2, str), i10, i11, new b.a() { // from class: com.anythink.nativead.api.ATNativeImageView.1
    ...
    public ATNativeImageView(Context context, AttributeSet attributeSet, int i10) {
