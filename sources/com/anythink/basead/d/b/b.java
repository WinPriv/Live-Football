...
public final class b {
    ...
    public static final String f3889a = "sdk_updatetime";
    ...
    public static final z a(j jVar, JSONObject jSONObject) {
        try {
            ...
            z zVar = new z();
            zVar.a(jVar.f);
            zVar.j(optJSONObject2.optString(l.f6241ad));
            zVar.k(optJSONObject2.optString("c_id"));
            zVar.w(optJSONObject2.optString(a.C0052a.A));
            zVar.l(optJSONObject2.optString("title"));
            zVar.m(optJSONObject2.optString("desc"));
            zVar.f(optJSONObject2.optInt(c.Y));
            ...
            zVar.r(optJSONObject2.optString(a.C0052a.f3676k));
            ...
            zVar.b(jSONObject.optLong(f3889a));
            ...
            zVar.A(optJSONObject2.optString(JavascriptBridge.MraidHandler.PRIVACY_ACTION));
            ...
            zVar.f(optJSONObject2.optString(r.f9698ab));
