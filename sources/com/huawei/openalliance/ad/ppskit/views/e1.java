...
public final class e1 extends c1 {
    public e1(Context context) {
        ...
        if (v3) {
            i11 = R.drawable.hiad_extand_app_down_btn_processing_elderly;
        } else {
            i11 = R.drawable.hiad_extand_app_down_btn_processing;
        }
        this.f23404b.f23409a = c1.a(i11, context);
        this.f23404b.f23410b = context.getResources().getColor(R.color.hiad_emui_black);
        if (v3) {
            i12 = R.drawable.hiad_extand_app_down_btn_installing_elderly;
        } else {
            i12 = R.drawable.hiad_extand_app_down_btn_installing;
        }
        this.f.f23409a = context.getResources().getDrawable(i12);
        this.f.f23410b = context.getResources().getColor(R.color.hiad_app_down_installing_text);
        if (v3) {
            i13 = R.drawable.hiad_linked_app_down_btn_installing_elderly;
        } else {
            i13 = R.drawable.hiad_linked_app_down_btn_installing;
        }
        this.f23405c.f23409a = context.getResources().getDrawable(i13);
