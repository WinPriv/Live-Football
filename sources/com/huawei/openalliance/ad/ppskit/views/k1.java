...
public final class k1 extends c1 {
    ...
    public k1(Context context) {
        ...
        if (v3) {
            i11 = R.drawable.hiad_ppswebview_app_down_btn_processing_hm_elderly;
        } else {
            i11 = R.drawable.hiad_ppswebview_app_down_btn_processing_hm;
        }
        ...
        if (!(findDrawableByLayerId instanceof ClipDrawable)) {
            ...
            if (v3) {
                i15 = R.drawable.hiad_extand_app_down_btn_processing_elderly;
            } else {
                i15 = R.drawable.hiad_extand_app_down_btn_processing;
            }
            bVar = this.f23404b;
            layerDrawable = c1.a(i15, context);
        } else {
        ...
        if (v3) {
            i12 = R.drawable.hiad_ppswebview_app_down_btn_installing_hm_elderly;
        } else {
            i12 = R.drawable.hiad_ppswebview_app_down_btn_installing_hm;
        }
        LayerDrawable layerDrawable3 = (LayerDrawable) c1.a(i12, context);
        boolean z10 = layerDrawable3.findDrawableByLayerId(android.R.id.progress) instanceof ClipDrawable;
        int i16 = R.drawable.hiad_ppswebview_app_down_btn_installing_elderly;
        if (!z10) {
            n7.g("ExtandAppDownloadButtonStyleHm", "not clipDrawable");
            if (v3) {
                i14 = R.drawable.hiad_ppswebview_app_down_btn_installing_elderly;
            } else {
                i14 = R.drawable.hiad_ppswebview_app_down_btn_installing;
            }
            this.f.f23409a = c1.a(i14, context);
        } else {
            if (v3) {
                i13 = 20;
            } else {
        ...
        this.f.f23410b = resources.getColor(R.color.hiad_emui_white);
        this.f23405c.f23409a = resources.getDrawable(v3 ? i16 : R.drawable.hiad_ppswebview_app_down_btn_installing);
