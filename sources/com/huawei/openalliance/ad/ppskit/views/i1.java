...
public final class i1 extends h1 {
    ...
    public float f23450z;

    public i1(Drawable drawable) {
        super(drawable);
        this.B = new Path();
    ...
    @Override // com.huawei.openalliance.ad.ppskit.views.h1
    public final Path a(int i10) {
        float f = i10 / 10000.0f;
        int compare = Float.compare(f, this.f23450z);
        RectF rectF = this.D;
        float f10 = gl.Code;
        RectF rectF2 = this.C;
        Path path = this.B;
        if (compare < 0) {
            ...
            if (Float.compare(this.f23450z, gl.Code) != 0) {
                f10 = (f / this.f23450z) * this.F;
            }
            Rect rect = this.E;
            Rect rect2 = this.E;
    ...
    @Override // com.huawei.openalliance.ad.ppskit.views.h1, android.graphics.drawable.Drawable
