...
public class c {
    ...
    private static WindowManager f24422a;

    /* renamed from: b, reason: collision with root package name */
    private static String[] f24423b = {"x", "y", ContentRecord.WIDTH, ContentRecord.HEIGHT};

    /* renamed from: c, reason: collision with root package name */
    static float f24424c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        b a10 = a(jSONObject);
        try {
            jSONObject.put(ContentRecord.WIDTH, a10.f24426a);
            jSONObject.put(ContentRecord.HEIGHT, a10.f24427b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f24422a != null) {
            ...
            f24422a.getDefaultDisplay().getRealSize(point);
            f = a(point.x);
            f10 = a(point.y);
        } else {
            f = gl.Code;
    ...
    public static void a(Context context) {
        if (context != null) {
            f24424c = context.getResources().getDisplayMetrics().density;
            f24422a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0312a c0312a) {
        com.iab.omid.library.ironsrc.internal.e a10 = c0312a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0312a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f24425a[outputDeviceStatus.ordinal()] == 1;
    }
