...
public class f extends a {
    public f(b.InterfaceC0316b interfaceC0316b, HashSet<String> hashSet, JSONObject jSONObject, long j10) {
        ...
        if (a10 != null) {
            for (com.iab.omid.library.vungle.adsession.a aVar : a10.b()) {
                if (((a) this).f24560a.contains(aVar.getAdSessionId())) {
                    aVar.getAdSessionStatePublisher().a(str, this.f24562c);
                }
            }
        }
    }
    ...
    public String doInBackground(Object... objArr) {
        if (com.iab.omid.library.vungle.d.b.b(this.f24561b, this.f24564d.b())) {
            return null;
        }
        this.f24564d.a(this.f24561b);
