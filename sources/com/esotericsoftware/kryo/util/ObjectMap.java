...
public class ObjectMap<K, V> {
    ...
    private void push(K k10, V v3, int i10, K k11, int i11, K k12, int i12, K k13, int i13, K k14) {
        ...
        while (true) {
            ...
            int hashCode = k18.hashCode();
            int i23 = hashCode & i15;
            K k20 = kArr[i23];
            if (k20 == null) {
                kArr[i23] = k18;
                vArr[i23] = v10;
    ...
    private V put_internal(K k10, V v3) {
        int i10;
        Object obj;
        ...
        push(k10, v3, i12, k11, hash2, k12, hash3, k13, i10, obj);
        return null;
    }
        ...
        if (!k10.equals(this.keyTable[this.mask & hashCode])) {
            if (!k10.equals(this.keyTable[hash2(hashCode)])) {
                if (!k10.equals(this.keyTable[hash3(hashCode)])) {
                    if (this.isBigTable) {
                        if (!k10.equals(this.keyTable[hash4(hashCode)])) {
    ...
    public V remove(K k10) {
        ...
        if (this.isBigTable) {
            int hash4 = hash4(hashCode);
            if (k10.equals(this.keyTable[hash4])) {
    ...
    public ObjectMap(int i10, float f) {
        if (i10 < 0) {
