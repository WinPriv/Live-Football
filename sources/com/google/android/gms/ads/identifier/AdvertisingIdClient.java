...
public class AdvertisingIdClient {
    ...
    public static Info getAdvertisingIdInfo(Context context) throws IOException, IllegalStateException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        ...
        try {
            ...
            advertisingIdClient.zzc(zzd, true, gl.Code, SystemClock.elapsedRealtime() - elapsedRealtime, "", null);
            return zzd;
        } finally {
        }
    }
    ...
    @VisibleForTesting
    public final boolean zzc(Info info, boolean z10, float f, long j10, String str, Throwable th) {
        if (Math.random() <= 0.0d) {
            String str2 = "1";
            HashMap t10 = l.t("app_context", "1");
            if (info != null) {
                if (true != info.isLimitAdTrackingEnabled()) {
                    str2 = "0";
                }
                t10.put("limit_ad_tracking", str2);
            ...
            if (th != null) {
                t10.put("error", th.getClass().getName());
            }
            t10.put(TemplateStyleRecord.TAG, "AdvertisingIdClient");
            t10.put("time_spent", Long.toString(j10));
            new zza(this, t10).start();
            return true;
        }
        return false;
    }
