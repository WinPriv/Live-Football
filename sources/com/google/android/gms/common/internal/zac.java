...
public final class zac {
    ...
    @GuardedBy("sCache")
    private static final i<String, String> zaa = new i<>();
    ...
    private static String zai(Context context, String str) {
        ...
        synchronized (iVar) {
            ...
            int identifier = remoteResource.getIdentifier(str, com.anythink.expressad.foundation.h.i.f10128g, "com.google.android.gms");
            if (identifier == 0) {
                if (str.length() != 0) {
