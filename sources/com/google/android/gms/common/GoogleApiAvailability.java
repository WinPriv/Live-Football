...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public final void zae(Context context, int i10, String str, PendingIntent pendingIntent) {
        ...
        if (DeviceProperties.isWearable(context)) {
            ...
            qVar.f2753v.icon = context.getApplicationInfo().icon;
            qVar.f2742j = 2;
            if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                qVar.f2735b.add(new l(com.google.android.gms.base.R.drawable.common_full_open_on_phone, resources.getString(com.google.android.gms.base.R.string.common_open_on_phone), pendingIntent));
            } else {
                qVar.f2739g = pendingIntent;
            }
        } else {
            qVar.f2753v.icon = android.R.drawable.stat_sys_warning;
            qVar.f2753v.tickerText = q.b(resources.getString(com.google.android.gms.base.R.string.common_google_play_services_notification_ticker));
            qVar.f2753v.when = System.currentTimeMillis();
            qVar.f2739g = pendingIntent;
            qVar.f = q.b(zae);
        }
        if (PlatformVersion.isAtLeastO()) {
