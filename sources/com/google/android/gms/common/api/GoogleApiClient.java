            ...
            for (Api<?> api2 : this.zaj.keySet()) {
                ...
                if (buildClient.providesSignIn()) {
                    if (api == null) {
                        ...
                        String zad3 = api.zad();
                        throw new IllegalStateException(k.m(new StringBuilder(String.valueOf(zad2).length() + 21 + String.valueOf(zad3).length()), zad2, " cannot be used with ", zad3));
                    }
                }
            }
            if (api != null) {
                if (!z12) {
                    ...
                    String zad4 = api.zad();
                    throw new IllegalStateException(k.m(new StringBuilder(String.valueOf(zad4).length() + 82), "With using ", zad4, ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                }
            }
