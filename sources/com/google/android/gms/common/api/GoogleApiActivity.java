        ...
        if (pendingIntent != null) {
            try {
                ...
                if (extras.getBoolean("notify_manager", true)) {
                    ...
                    String m10 = k.m(new StringBuilder(obj.length() + 36), "Activity not found while launching ", obj, ".");
                    if (Build.FINGERPRINT.contains("generic")) {
                        m10 = m10.concat(" This may occur when resolving Google Play services connection issues on emulators with Google APIs but not Google Play Store.");
                    }
                    Log.e("GoogleApiActivity", m10, e10);
                }
                this.zaa = 1;
                finish();
                return;
