...
public class GoogleApiManager implements Handler.Callback {
    ...
    @GuardedBy("lock")
    private final Set<ApiKey<?>> zar = new d();
    private final Set<ApiKey<?>> zas = new d();
    ...
    public static Status zaH(ApiKey<?> apiKey, ConnectionResult connectionResult) {
        ...
        return new Status(connectionResult, l.q(new StringBuilder(String.valueOf(zab2).length() + 63 + valueOf.length()), "API: ", zab2, " is not available on this device. Connection failed with: ", valueOf));
    }
            ...
            case 5:
                ...
                if (zabqVar != null) {
                    if (connectionResult.getErrorCode() == 13) {
                        ...
                        zabq.zai(zabqVar, new Status(17, l.q(new StringBuilder(String.valueOf(errorString).length() + 69 + String.valueOf(errorMessage).length()), "Error resolution was canceled by the user, original error message: ", errorString, ": ", errorMessage)));
                    } else {
