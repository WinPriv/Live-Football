...
public final class DynamiteModule {
    ...
    public static DynamiteModule load(Context context, VersionPolicy versionPolicy, String str) throws LoadingException {
        ...
        try {
            ...
            Log.i("DynamiteModule", "Considering local module " + str + w.bE + selectModule.localVersion + " and remote module " + str + w.bE + selectModule.remoteVersion);
    ...
    */
    ...
    private static boolean zzf(Context context) {
        ...
        if (zzf == null) {
            ...
            if (z10 && resolveContentProvider != null && (applicationInfo = resolveContentProvider.applicationInfo) != null && (applicationInfo.flags & a.T) == 0) {
