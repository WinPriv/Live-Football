...
public abstract class zzjk<MessageType extends zzjk<MessageType, BuilderType>, BuilderType extends zzjj<MessageType, BuilderType>> implements zzmi {
    ...
    public static void zzbw(Iterable iterable, List list) {
        ...
        if (iterable instanceof zzlq) {
            ...
            for (Object obj : zzh) {
                if (obj == null) {
                    String j10 = l.j("Element at index ", zzlqVar.size() - size, " is null.");
        ...
        if (!(iterable instanceof zzmp)) {
            ...
            for (Object obj2 : iterable) {
                if (obj2 == null) {
                    String j11 = l.j("Element at index ", list.size() - size3, " is null.");
                    int size4 = list.size();
                    while (true) {
                        size4--;
                        if (size4 < size3) {
    ...
    public final zzka zzbv() {
        try {
            ...
            throw new RuntimeException(k.l("Serializing ", getClass().getName(), " to a ByteString threw an IOException (should never happen)."), e10);
        }
    }
    ...
    public final byte[] zzbx() {
        try {
            ...
            throw new RuntimeException(k.l("Serializing ", getClass().getName(), " to a byte array threw an IOException (should never happen)."), e10);
        }
    }
}
