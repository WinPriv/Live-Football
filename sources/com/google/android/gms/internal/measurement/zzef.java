...
public final class zzef {
    ...
    public final void zzC(com.google.android.gms.measurement.internal.zzhg zzhgVar) {
        ...
        synchronized (this.zzf) {
            for (int i10 = 0; i10 < this.zzf.size(); i10++) {
                if (zzhgVar.equals(((Pair) this.zzf.get(i10)).first)) {
    ...
    public final List zzq(String str, String str2) {
        ...
        List list = (List) zzbz.zzf(zzbzVar.zzb(f.f7962a), List.class);
        if (list == null) {
    ...
    public final Map zzr(String str, String str2, boolean z10) {
        ...
        Bundle zzb = zzbzVar.zzb(f.f7962a);
