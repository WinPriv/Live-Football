...
public final class zzjo {
    ...
    public static int zzb(byte[] bArr, int i10) {
        ...
        int i12 = bArr[i10 + 1] & DefaultClassResolver.NAME;
        int i13 = bArr[i10 + 2] & DefaultClassResolver.NAME;
        return ((bArr[i10 + 3] & DefaultClassResolver.NAME) << 24) | (i12 << 8) | i11 | (i13 << 16);
    }
