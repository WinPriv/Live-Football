    ...
    public final zzap zza(String str, zzg zzgVar, List list) {
        ...
        if (ordinal != 1) {
            if (ordinal != 47) {
                ...
                zzap zzb = zzgVar.zzb((zzap) k.h(zzbl.OR, 2, list, 0));
                if (zzb.zzg().booleanValue()) {
                    return zzb;
                }
                return zzgVar.zzb((zzap) list.get(1));
            }
            return new zzaf(Boolean.valueOf(!zzgVar.zzb((zzap) k.h(zzbl.NOT, 1, list, 0)).zzg().booleanValue()));
        }
        zzap zzb2 = zzgVar.zzb((zzap) k.h(zzbl.AND, 2, list, 0));
