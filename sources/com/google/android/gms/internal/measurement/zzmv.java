...
public final class zzmv {
    ...
    public static Object zzA(Object obj, int i10, int i11, Object obj2, zznk zznkVar) {
        if (obj2 == null) {
    ...
    public static void zzD(int i10, List list, zzoc zzocVar, boolean z10) throws IOException {
        if (list != null && !list.isEmpty()) {
            zzocVar.zzc(i10, list, z10);
        }
    }

    public static void zzE(int i10, List list, zzoc zzocVar) throws IOException {
        if (list != null && !list.isEmpty()) {
            zzocVar.zze(i10, list);
        }
    }

    public static void zzF(int i10, List list, zzoc zzocVar, boolean z10) throws IOException {
        if (list != null && !list.isEmpty()) {
    ...
    public static void zzK(int i10, List list, zzoc zzocVar, zzmt zzmtVar) throws IOException {
        if (list != null && !list.isEmpty()) {
    ...
    public static void zzL(int i10, List list, zzoc zzocVar, boolean z10) throws IOException {
        if (list != null && !list.isEmpty()) {
    ...
    public static void zzN(int i10, List list, zzoc zzocVar, zzmt zzmtVar) throws IOException {
        if (list != null && !list.isEmpty()) {
            for (int i11 = 0; i11 < list.size(); i11++) {
    ...
    public static void zzO(int i10, List list, zzoc zzocVar, boolean z10) throws IOException {
        if (list != null && !list.isEmpty()) {
    ...
    public static void zzS(int i10, List list, zzoc zzocVar) throws IOException {
        if (list != null && !list.isEmpty()) {
            zzocVar.zzG(i10, list);
        }
    }

    public static void zzT(int i10, List list, zzoc zzocVar, boolean z10) throws IOException {
        if (list != null && !list.isEmpty()) {
