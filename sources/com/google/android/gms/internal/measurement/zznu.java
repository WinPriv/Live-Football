...
final class zznu {
    ...
    public static void zzD(Object obj, long j10, byte b10) {
        ...
        int i11 = ((~((int) j10)) & 3) << 3;
        zzntVar.zza.putInt(obj, j11, ((255 & b10) << i11) | (i10 & (~(p.f9095b << i11))));
    }
    ...
    public static void zzE(Object obj, long j10, byte b10) {
        ...
        long j11 = (-4) & j10;
        int i10 = (((int) j10) & 3) << 3;
        zzntVar.zza.putInt(obj, j11, ((255 & b10) << i10) | (zzntVar.zza.getInt(obj, j11) & (~(p.f9095b << i10))));
    }
    ...
    public static /* bridge */ /* synthetic */ boolean zzt(Object obj, long j10) {
        if (((byte) ((zzf.zza.getInt(obj, (-4) & j10) >>> ((int) (((~j10) & 3) << 3))) & p.f9095b)) != 0) {
            return true;
        }
        return false;
    }
