...
public abstract class zzlb<MessageType extends zzlb<MessageType, BuilderType>, BuilderType extends zzkx<MessageType, BuilderType>> extends zzjk<MessageType, BuilderType> {
    ...
    public final int zzbu(zzmt zzmtVar) {
        if (zzbR()) {
            ...
            throw new IllegalStateException(l.i("serialized size must be non-negative, was ", zza2));
        }
        ...
        throw new IllegalStateException(l.i("serialized size must be non-negative, was ", zza3));
    }
    ...
    public final int zzbz() {
        ...
        if (zzbR()) {
            i10 = zza(null);
            if (i10 < 0) {
                throw new IllegalStateException(l.i("serialized size must be non-negative, was ", i10));
            }
        } else {
