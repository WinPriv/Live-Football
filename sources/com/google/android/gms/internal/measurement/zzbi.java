    ...
    public final zzap zza(String str, zzg zzgVar, List list) {
        ...
        if (ordinal != 0) {
            if (ordinal != 21) {
                if (ordinal != 59) {
                    if (ordinal != 52 && ordinal != 53) {
                        if (ordinal != 55 && ordinal != 56) {
                            switch (ordinal) {
                                case 44:
                                    return new zzah(Double.valueOf(zzgVar.zzb((zzap) k.h(zzbl.MODULUS, 2, list, 0)).zzh().doubleValue() % zzgVar.zzb((zzap) list.get(1)).zzh().doubleValue()));
                                case 45:
                                    return new zzah(Double.valueOf(zzgVar.zzb((zzap) list.get(1)).zzh().doubleValue() * zzgVar.zzb((zzap) k.h(zzbl.MULTIPLY, 2, list, 0)).zzh().doubleValue()));
                                case 46:
                                    return new zzah(Double.valueOf(-zzgVar.zzb((zzap) k.h(zzbl.NEGATE, 1, list, 0)).zzh().doubleValue()));
                                default:
                ...
                zzap zzb2 = zzgVar.zzb((zzap) k.h(zzbl.SUBTRACT, 2, list, 0));
            ...
            return new zzah(Double.valueOf(zzgVar.zzb((zzap) k.h(zzbl.DIVIDE, 2, list, 0)).zzh().doubleValue() / zzgVar.zzb((zzap) list.get(1)).zzh().doubleValue()));
        }
        zzap zzb3 = zzgVar.zzb((zzap) k.h(zzbl.ADD, 2, list, 0));
