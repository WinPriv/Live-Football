...
public final class Strings {
    ...
    private static String lenientToString(@NullableDecl Object obj) {
        try {
            ...
            Logger.getLogger("com.applovin.exoplayer2.common.base.Strings").log(Level.WARNING, "Exception during lenientFormat for " + str, (Throwable) e10);
            StringBuilder s10 = l.s("<", str, " threw ");
    ...
    public static String repeat(String str, int i10) {
        ...
        if (i11 == j10) {
            ...
            throw new ArrayIndexOutOfBoundsException(k.k("Required array size too large: ", j10));
        }
    }
