...
public class ReportDBAdapter implements DBAdapter<Report> {
    ...
    Type stringType = new a<ArrayList<String>>() { // from class: com.vungle.warren.model.ReportDBAdapter.1
    }.getType();
    Type userActionsType = new a<ArrayList<Report.UserAction>>() { // from class: com.vungle.warren.model.ReportDBAdapter.2
    }.getType();
    ...
    public Report fromContentValues(ContentValues contentValues) {
        ...
        List list = (List) this.gson.c(contentValues.getAsString(ReportColumns.COLUMN_CLICKED_THROUGH), this.stringType);
        List list2 = (List) this.gson.c(contentValues.getAsString(ReportColumns.COLUMN_ERRORS), this.stringType);
        List list3 = (List) this.gson.c(contentValues.getAsString(ReportColumns.COLUMN_USER_ACTIONS), this.userActionsType);
        if (list != null) {
    ...
    public ContentValues toContentValues(Report report) {
        ...
        contentValues.put("placementId", report.placementId);
        ...
        contentValues.put(ReportColumns.COLUMN_USER_ACTIONS, this.gson.k(new ArrayList(report.userActions), this.userActionsType));
        contentValues.put(ReportColumns.COLUMN_CLICKED_THROUGH, this.gson.k(new ArrayList(report.clickedThrough), this.stringType));
        contentValues.put(ReportColumns.COLUMN_ERRORS, this.gson.k(new ArrayList(report.errors), this.stringType));
