...
public class AdvertisementDBAdapter implements DBAdapter<Advertisement> {
    ...
    static final Type CHECKPOINT_LIST_TYPE = new a<List<Advertisement.Checkpoint>>() { // from class: com.vungle.warren.model.AdvertisementDBAdapter.3
    }.getType();
    static final Type DYNAMIC_EVENTS_AND_URLS_TYPE = new a<Map<String, ArrayList<String>>>() { // from class: com.vungle.warren.model.AdvertisementDBAdapter.4
    }.getType();
    ...
    private final Type STRING_LIST_TYPE = new a<List<String>>() { // from class: com.vungle.warren.model.AdvertisementDBAdapter.6
    }.getType();
    ...
    public Advertisement fromContentValues(ContentValues contentValues) {
        ...
        advertisement.adConfig = (AdConfig) this.gson.b(AdConfig.class, contentValues.getAsString(AdvertisementColumns.COLUMN_AD_CONFIG));
        advertisement.checkpoints = (List) this.gson.c(contentValues.getAsString(AdvertisementColumns.COLUMN_CHECKPOINTS), CHECKPOINT_LIST_TYPE);
        advertisement.dynamicEventsAndUrls = (Map) this.gson.c(contentValues.getAsString(AdvertisementColumns.COLUMN_DYNAMIC_EVENTS_AND_URLS), DYNAMIC_EVENTS_AND_URLS_TYPE);
        advertisement.templateSettings = (Map) this.gson.c(contentValues.getAsString(AdvertisementColumns.COLUMN_TEMPLATE_SETTINGS), this.stringMapType);
        advertisement.mraidFiles = (Map) this.gson.c(contentValues.getAsString(AdvertisementColumns.COLUMN_MRAID_FILES), this.stringMapType);
        advertisement.cacheableAssets = (Map) this.gson.c(contentValues.getAsString(AdvertisementColumns.COLUMN_CACHEABLE_ASSETS), this.cacheableMapType);
        ...
        advertisement.setWinNotifications((List) this.gson.c(contentValues.getAsString(AdvertisementColumns.COLUMN_NOTIFICATIONS), this.STRING_LIST_TYPE));
    ...
    public ContentValues toContentValues(Advertisement advertisement) {
        ...
        contentValues.put(AdvertisementColumns.COLUMN_AD_CONFIG, this.gson.j(advertisement.adConfig));
        contentValues.put(AdvertisementColumns.COLUMN_CHECKPOINTS, this.gson.k(advertisement.checkpoints, CHECKPOINT_LIST_TYPE));
        contentValues.put(AdvertisementColumns.COLUMN_DYNAMIC_EVENTS_AND_URLS, this.gson.k(advertisement.dynamicEventsAndUrls, DYNAMIC_EVENTS_AND_URLS_TYPE));
        contentValues.put(AdvertisementColumns.COLUMN_TEMPLATE_SETTINGS, this.gson.k(advertisement.templateSettings, this.stringMapType));
        contentValues.put(AdvertisementColumns.COLUMN_MRAID_FILES, this.gson.k(advertisement.mraidFiles, this.stringMapType));
        contentValues.put(AdvertisementColumns.COLUMN_CACHEABLE_ASSETS, this.gson.k(advertisement.cacheableAssets, this.cacheableMapType));
        contentValues.put(AdvertisementColumns.COLUMN_NOTIFICATIONS, this.gson.k(advertisement.getWinNotifications(), this.STRING_LIST_TYPE));
